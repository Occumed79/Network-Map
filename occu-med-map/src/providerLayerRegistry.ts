...
export const PROVIDER_LAYER_CATEGORIES: readonly ProviderLayerCategory[] = [
  ...
  liveRegistrySource('wales-gp-main-sites', 'Wales — GP Main + Branch Sites', '#d946ef'),
  ...
  liveRegistrySource('gisco-hospitals-hungary', 'Hungary — Eurostat/GISCO Hospitals', '#16a34a'),
  liveRegistrySource('gisco-hospitals-italy', 'Italy — Eurostat/GISCO Hospitals', '#059669'),
  liveRegistrySource('gisco-hospitals-luxembourg', 'Luxembourg — Eurostat/GISCO Hospitals', '#9333ea'),
  liveRegistrySource('gisco-hospitals-malta', 'Malta — Eurostat/GISCO Hospitals', '#0d9488'),
  liveRegistrySource('gisco-hospitals-netherlands', 'Netherlands — Eurostat/GISCO Hospitals', '#ea580c'),
  liveRegistrySource('gisco-hospitals-norway', 'Norway — Eurostat/GISCO Hospitals', '#0369a1'),
  liveRegistrySource('gisco-hospitals-poland', 'Poland — Eurostat/GISCO Hospitals', '#b91c1c'),
  liveRegistrySource('gisco-hospitals-portugal', 'Portugal — Eurostat/GISCO Hospitals', '#15803d'),
  liveRegistrySource('gisco-hospitals-romania', 'Romania — Eurostat/GISCO Hospitals', '#7e22ce'),
  liveRegistrySource('gisco-hospitals-serbia', 'Serbia — Eurostat/GISCO Hospitals', '#334155'),
  liveRegistrySource('gisco-hospitals-sweden', 'Sweden — Eurostat/GISCO Hospitals', '#0284c7'),
  liveRegistrySource('gisco-hospitals-slovenia', 'Slovenia — Eurostat/GISCO Hospitals', '#0f766e'),
  liveRegistrySource('gisco-hospitals-slovakia', 'Slovakia — Eurostat/GISCO Hospitals', '#2563eb'),
